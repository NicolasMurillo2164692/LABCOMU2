...
# Title: PRACTICA_3
# Author: NicolasMurillo_AndreySalom_DannyNavarro
# Copyright: UIS
# Description: Grupo3
...
import LAB3_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
...
class LAB3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "PRACTICA_3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PRACTICA_3")
